...
<body>
    ...
    <section class="breadcrumb-wrapper">
        <div class="container">
            ...
            <ul class="breadcrumb-list">
                ...
                <li class="breadcrumb-item">200 Yoga Teacher Training Rishikesh, India</li>
            </ul>
        </div>
    </section>
    <!-- end -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="course-detail-wrapper">
                        ...
                        <iframe width="200%" height="405" src="https://www.youtube.com/embed/v7AYKMP6rOE?si=-Fu0djH0cSNva_ok" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
    ...
    <section class="yoga-syllabus space">
        <div class="container">
            <div class="heading-wrap">
                <h1 class="main-heading">200HR course syllabus</h1>
                <span class="sub-title">Connect with the Stories Behind the Practice</span>
            </div>
    ...
    <section class="space bg">
        <div class="container">
            <div class="heading-wrap">
                ...
                <span class="sub-title">We Provide 200Hr, 200Hr Yoga TTC and Yoga Retreat Programs in Rishikesh,
                    India</span>
            </div>
