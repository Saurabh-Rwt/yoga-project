...
<head>
    <title>200 Hour Yoga Teacher Training in Rishikesh, India</title>
    <!-- css -->
...
<body>
    ...
    <section class="breadcrumb-wrapper">
        <div class="container">
            <h2 class="breadcrumb-title">200 Hour Yoga Teacher Training in Rishikesh, India</h2>
            <ul class="breadcrumb-list">
                <li class="breadcrumb-item"><a href="<?php echo $link;?>">home</a></li>
                <li class="breadcrumb-item">200 Hour Yoga TTC in Rishikesh, India</li>
            </ul>
        </div>
    </section>
    <!-- end -->
    ...
    <!-- course detail -->
    <section class="space course-detail-sec">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-list">
                            <li>
                                ...
                                <span class="detail">25 days</span>
                            </li>
                            <li>
                            ...
                            <li>
                                <span class="list-title">module:</span>
                                <span class="detail">residential with meals</span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span class="detail">yoga alliance</span>
                            </li>
                            <li>
                                <span class="list-title">date:</span>
                                <span class="detail">2nd - 26th of every month</span>
                            </li>
                        </ul>
                        <div class="prices-wrap">
                            <div class="description">
                                <h3 class="price">usd 1100</h3>
                                <span class="room">shared room</span>
                            </div>
                            <div class="description">
                                <h3 class="price">usd 1250</h3>
                ...
                <div class="col-lg-8">
                    <div class="course-detail-wrapper">
                        <img src="assets/images/200-hours-yoga-ttc-rishikesh/200-hour-yoga-ttc-01.jpg" class="img-fluid mb-4" alt="">

                        <h2 class="main-title">200 hour yoga TTC in Rishikesh, india</h2>
                        <p>Are you ready to have the adventure of a lifetime? Well, what we mean by this is that it's time to jump into the yogic world with our exclusive 200 hour Yoga TTC in Rishikesh. This course will take you on a beautiful journey of self-discovery, inner strength, and outer flexibility by providing you with the opportunity to explore the ancient yoga teachings, which are also in the yoga capital of the world, Rishikesh.</p>

                        <p>
                        During this course, you will be given the chance to explore and learn from the beginning about the different aspects of yoga, which will include various pranayama, asanas, teaching methods, anatomy, and philosophy. We have a trict curriculum through which you will gain the required theoretical knowledge along with practical experience, which is a must-have to excel as a skilled yoga instructor. Our programme is sure to ignite your yoga passion while providing you with all the necessary tools and knowledge required to become a certified yoga teacher.
                        </p>

                        <p>
                        Whether you're looking to enhance your personal practice or start a new career as a yoga teacher, our 200-hour TTC offers an unforgettable journey that will leave a lasting impact. 
                        </p>

                        <h3 class="sub-heading">Here's what you can expect:</h3>
                        <ul class="list">
                            <li>Various Learning Methods: Here you will explore the different yoga forms, such as Hatha, Vinyasa, and Ashtanga Yoga.</li>
                            <li>Active Learning Experience: Practice teaching classes and observing others to strengthen your communication skills and boost your confidence.</li>
                            <li>Engaging Community: Connect with fellow learners and receive ongoing support and guidance even after completing the course.</li>
                        </ul>
                        <p>Join us as we embark on a journey of personal growth, transformation, and self-discovery. Let's roll out the yoga mats and descend into the magic of yoga together!</p>
                    </div>
                    ...
                    <div class="course-detail-wrapper">
                        ...
                        <div class="schedule-dates">
                            ...
                            <div class="dates-body">
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Apr - 26 Apr 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1250<del>$1550</del></span>
                                    </div>
                                    <div class="item">
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 May - 26 May 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Jun - 26 Jul 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Aug - 26 Aug 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Sep - 26 Sep 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Oct - 26 Oct 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Nov - 26 Nov 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Dec - 26 Dec 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$1100<del>$1300</del></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="assets/images/gallery/13.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-6">
                                <img src="assets/images/gallery/14.jpg" alt="" class="img-fluid">>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="course-detail-wrapper">
                        <h2 class="main-title">Daily schedule for 200 hour yoga TTC</h2>
    ...
    <section class="welcome-section space">
        <div class="container">
            <div class="heading-wrap">
                ...
                <span class="sub-title">Upon completion, receive certification as a confident yoga instructor</span>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <img src="assets/images/niya-yoga-studio-certificate.jpg" class="img-fluid wlcm-img" alt="">
                    <p>Once the student has completed the 200 Hour Yoga Teacher Training in Rishikesh,they will be given
                        a certificate from the institution. The certificate will have a record of the hours spent on the
                        course and state the fact that they will be henceforth able to hold a license as a yoga teacher.
                        The certificate is issued by the Yoga Alliance which is one of the biggest organizations that is
                        involved in the yogic lifestyle for years and is highly recognized and authentic.
                    </p>
                    <p>Attention is also given to ensuring that your teaching effectiveness is improved with regard to
                        methodology and curriculum design. Learning the techniques for dynamic and engaging classes and
                        the essential demands of good direction and class management.</p>
                    <p class="">
                        The programme wraps up when you become certified as a yoga instructor, not just at the end, but
                        with the complete knowledge and confidence needed to help students in their journey. Be it a
                        career choice or self-actualization, our programme is a deep dive into theory and practices. You
                        will be equipped with all you need to work on and teach yoga to others, as things will be done
                        starting from deep within yourself.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="yoga-syllabus space">
        <div class="container">
            <div class="heading-wrap">
                <h1 class="main-heading">200HR Yoga TTC syllabus</h1>
                <span class="sub-title">Course Syllabus - 200 Hour Yoga Teacher Training In Rishikesh India</span>
            </div>
            <p>Our 200 hour Yoga Teacher Training Course (TTC) offers a holistic curriculum that mixes classroom learning and hands-on practice sessions, empowering future instructors with the right tools and know-how, especially when leading a yoga class. The participants will discover what yoga philosophy is and what anatomical aspects of the practice comprise it. They will also examine asanas, teaching methodology, sequencing techniques, and correct alignment through a combination of theory and practical work. In addition, they will practice how to manage class.</p>
            <p>The following subjects will teach according to course type and days-:</p>
            ...
            <div class="syllabus-wrapper">
                ...
                <div class="syllabus-card">
                    ...
                    <div class="content">
                        ...
                        <p>Using physical props to support postural understanding, enhance the benefits of the pose and facilitate healing.</p>
                    </div>
                </div>
                <div class="syllabus-card">
                    <div class="count">
                    ...
                    <div class="content">
                        ...
                        <p>Learn to interpret breathing patterns and provide practices to correct and improve physical condition.</p>
                    </div>
                </div>
                <div class="syllabus-card">
                    <div class="count">
