...
<body>
    ...
    <section class="breadcrumb-wrapper">
        <div class="container">
            <h2 class="breadcrumb-title">100 Hour Yoga Teacher Training in Rishikesh, India</h2>
            <ul class="breadcrumb-list">
                <li class="breadcrumb-item"><a href="<?php echo $link;?>">home</a></li>
                <li class="breadcrumb-item">100 Hour Yoga TTC in Rishikesh, India</li>
            </ul>
        </div>
    </section>
    <!-- end -->
            ...
            <div class="row">
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-list">
                            <li>
                                ...
                                <span class="detail">12 days</span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span class="detail">2 - 13 of every month</span>
                            </li>
                        </ul>
                        <div class="prices-wrap">
                            <div class="description">
                                <h3 class="price">usd 500</h3>
                ...
                <div class="col-lg-8">
                    <div class="course-detail-wrapper">
                        <img src="assets/images/100-hours-yoga-ttc-rishikesh/32.jpg" class="img-fluid mb-4" alt="">

                        <h2 class="main-title">100 hour yoga TTC in Rishikesh, india</h2>
                        <p>Sink in the mystical beauty of yoga with our intense 100 hour Yoga Teacher Training Course
                            (TTC). This course is a great first step to becoming a teacher or just to deepen your
                            personal practice and learn the fundamental principles to forge ahead with confidence!</p>

                        <p>Under the careful guidance of widely experienced instructors, you will start your journey,
                            probing into the mysteries of yoga practice, mastering all basic poses, and understanding
                            the skillful delivery of the rituals. By doing interactive workshops and group discussions,
                            as well as planning and teaching practical lessons, you will polish your communication
                            skills and learn how to create a welcoming environment for all levels of students, which
                            will be empowering instead of excluding them.</p>

                        <h3 class="sub-heading">Here's what you can expect:</h3>
                        <ul class="list">
                            <li>In-depth programme that would include yogic philosophy, anatomy, and teaching styles.
                            </li>
                            <li>Practice of asana daily to continuously improve your physical technique.</li>
                            <li>Focus on efficient methods of teaching, arranging the required things, and student
                                organisation in the classroom.</li>
                            <li>Workshops and group discussions on comprehensive perfectionism.</li>
                            <li>Yoga Certification in Rishikesh after practice allows you to instruct all participants
                                with so much confidence and depth in the meaning of yoga as a lifestyle.</li>
                        </ul>
                        <p>A completely transformational yoga teacher training for those who want to pursue teaching as
                            a career or learn to practice yoga deeply. This 100 hour TTC enables participants to evolve
                            profoundly on a personal level, become self-actualized individuals, and share yoga with
                            others. </p>
                    </div>
                    ...
                    <div class="course-detail-wrapper">
                        ...
                        <div class="schedule-dates">
                            ...
                            <div class="dates-body">
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Apr - 13 Apr 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$650<del>$900</del></span>
                                    </div>
                                    <div class="item">
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 May - 13 May 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Jun - 13 Jun 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Jul - 13 Jul 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Aug - 13 Aug 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Sep - 13 Sep 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Oct - 13 Oct 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                                ...
                                <div class="dates-box">
                                    <div class="item">
                                        <span class="course-date">2 Nov - 13 Nov 2024</span>
                                    </div>
                                    <div class="item">
                                        <span class="price">$500<del>$750</del></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="assets/images/gallery/11.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="course-detail-wrapper">
                        <h2 class="main-title">Daily schedule for 100 hour yoga TTC</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Once the student has completed the 100 Hour Yoga Teacher Training in Rishikesh,they will be given
