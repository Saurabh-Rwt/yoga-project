...
<body>
    ...
    <section class="breadcrumb-wrapper">
        <div class="container">
            <h2 class="breadcrumb-title">300 Hour Yoga Teacher Training in Rishikesh, India</h2>
            <ul class="breadcrumb-list">
                <li class="breadcrumb-item"><a href="<?php echo $link;?>">home</a></li>
                <li class="breadcrumb-item">300 Yoga Teacher Training Rishikesh, India</li>
            </ul>
        </div>
    </section>
    <!-- end -->
            ...
            <div class="row">
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-list">
                            <li>
                                ...
                                <span class="detail">27 days</span>
                            </li>
                            <li>
                ...
                <div class="col-lg-8">
                    <div class="course-detail-wrapper">
                        ...
                        <h2 class="main-title">300 hour yoga TTC in Rishikesh, india</h2>
                    ...
                    <div class="course-detail-wrapper">
                        <h2 class="main-title">Daily schedule for 300 hour yoga TTC</h2>
                        ...
                        <iframe width="300%" height="405" src="https://www.youtube.com/embed/v7AYKMP6rOE?si=-Fu0djH0cSNva_ok" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
    ...
    <section class="yoga-syllabus space">
        <div class="container">
            <div class="heading-wrap">
                <h1 class="main-heading">300HR course syllabus</h1>
                <span class="sub-title">Connect with the Stories Behind the Practice</span>
            </div>
    ...
    <section class="space bg">
        <div class="container">
            <div class="heading-wrap">
                ...
                <span class="sub-title">We Provide 300Hr, 200Hr Yoga TTC and Yoga Retreat Programs in Rishikesh,
                    India</span>
            </div>
